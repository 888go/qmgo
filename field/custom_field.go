...
// [提示:] func (c *自定义字段) 设置更新时间字段(fieldName 字符串) 自定义字段构建器 {}设置更新时间字段名
// ff:设置更新时间字段名
// c:
// fieldName:字段名称
...
// [提示:] func (c *自定义字段) 设置创建时间(fieldName string) 自定义字段构建器 {}设置创建时间字段名
// ff:设置创建时间字段名
// c:
// fieldName:字段名称
...
// [提示:] func (c *自定义字段) 设置唯一标识(fieldName 字符串) 自定义字段构建器 {}设置ID字段名
// ff:设置ID字段名
// c:
// fieldName:字段名称
...
// [提示:] func (c 自定义字段) 创建时间定制(doc interface{})自定义创建时间
// ff:自定义创建时间
// c:
// doc:待插入文档
...
// [提示:] func (c 自定义字段) 自定义更新时间(doc interface{})自定义更新时间
// ff:自定义更新时间
// c:
// doc:待插入文档
...
// CustomUpdateTime 修改自定义更新时间 md5:71153ba9520a179c自定义更新时间
// [提示:] func (c 自定义字段) 自定义Id(文档 interface{})自定义ID
// ff:自定义ID
// c:
// doc:待插入文档
