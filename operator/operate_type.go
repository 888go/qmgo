...
const (
	...
	BeforeUpsert  OpType = "beforeUpsert"  //qm:常量_钩子_替换插入前  cz:BeforeUpsert OpType = "beforeUpsert"
	AfterUpsert   OpType = "afterUpsert"   //qm:常量_钩子_替换插入后  cz:AfterUpsert OpType = "afterUpsert"
