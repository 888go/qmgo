...
//
// [结束]
type UpdateResult struct { //hm:更新结果结构 cz:type UpdateResult
	MatchedCount  int64       // 过滤器匹配到的文档数量。 md5:cac9d662a816ba41 //qm:匹配数 cz:MatchedCount  int64
	ModifiedCount int64       // 该操作修改的文档数量。 md5:d5082cfa94d1e2ea  //qm:修改数 cz:ModifiedCount int64
	UpsertedCount int64       // 由该操作上载的文档数量。 md5:0872523e362c0f10 //qm:插入更新数 cz:UpsertedCount int64
	UpsertedID    interface{} // upsert文档的_id字段，如果没有进行upsert操作则为nil。 md5:681ec03a43493d1c //qm:插入ID cz:UpsertedID    interface{}
}
